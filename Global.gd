...
var TEAMS = {
	...
	# Avrupa Devleri & UEFA Uluslar Ligi
	"FRANSA":         {"colors": [Color8(0, 35, 149), Color8(255, 255, 255)],   "short": "FRA", "league": "NATIONAL", "type": "national"},
	"İSPANYA":        {"colors": [Color8(198, 11, 30), Color8(255, 196, 0)],    "short": "ESP", "league": "NATIONAL", "type": "national"},
	"ALMANYA":        {"colors": [Color8(255, 255, 255), Color8(0, 0, 0)],      "short": "GER", "league": "NATIONAL", "type": "national"},
	"BELÇİKA":        {"colors": [Color8(237, 27, 46), Color8(0, 0, 0)],        "short": "BEL", "league": "NATIONAL", "type": "national"},
	"HOLLANDA":       {"colors": [Color8(243, 111, 33), Color8(255, 255, 255)], "short": "NED", "league": "NATIONAL", "type": "national"},
	"HIRVATİSTAN":    {"colors": [Color8(255, 255, 255), Color8(255, 0, 0)],    "short": "CRO", "league": "NATIONAL", "type": "national"},
	"DANİMARKA":      {"colors": [Color8(200, 16, 46), Color8(255, 255, 255)],  "short": "DEN", "league": "NATIONAL", "type": "national"},
	"İSVİÇRE":        {"colors": [Color8(218, 41, 28), Color8(255, 255, 255)],  "short": "SUI", "league": "NATIONAL", "type": "national"},
	"AVUSTURYA":      {"colors": [Color8(237, 41, 57), Color8(255, 255, 255)],  "short": "AUT", "league": "NATIONAL", "type": "national"},
	"POLONYA":        {"colors": [Color8(255, 255, 255), Color8(220, 20, 60)],  "short": "POL", "league": "NATIONAL", "type": "national"},
	"SIRBİSTAN":      {"colors": [Color8(198, 54, 60), Color8(12, 64, 118)],    "short": "SRB", "league": "NATIONAL", "type": "national"},
	"ÇEKYA":          {"colors": [Color8(215, 20, 26), Color8(17, 69, 126)],    "short": "CZE", "league": "NATIONAL", "type": "national"},
	"İSKOÇYA":        {"colors": [Color8(0, 43, 92), Color8(255, 255, 255)],    "short": "SCO", "league": "NATIONAL", "type": "national"},
	"NORVEÇ":         {"colors": [Color8(186, 12, 47), Color8(0, 32, 91)],      "short": "NOR", "league": "NATIONAL", "type": "national"},
	# Güney Amerika & CONMEBOL Elitleri
	"BREZİLYA":       {"colors": [Color8(254, 223, 0), Color8(0, 151, 57)],     "short": "BRA", "league": "NATIONAL", "type": "national"},
	"URUGUAY":        {"colors": [Color8(85, 165, 225), Color8(0, 0, 0)],       "short": "URU", "league": "NATIONAL", "type": "national"},
	"KOLOMBİYA":      {"colors": [Color8(255, 205, 0), Color8(0, 48, 135)],     "short": "COL", "league": "NATIONAL", "type": "national"},
	"ŞİLİ":           {"colors": [Color8(213, 43, 30), Color8(0, 57, 166)],     "short": "CHI", "league": "NATIONAL", "type": "national"},
	"PARAGUAY":       {"colors": [Color8(213, 43, 30), Color8(255, 255, 255)],  "short": "PAR", "league": "NATIONAL", "type": "national"},
	"EKVADOR":        {"colors": [Color8(255, 215, 0), Color8(0, 51, 153)],     "short": "ECU", "league": "NATIONAL", "type": "national"},
	# Afrika & AFCON Yıldızları
	"NİJERYA":        {"colors": [Color8(0, 135, 81), Color8(255, 255, 255)],   "short": "NGA", "league": "NATIONAL", "type": "national"},
	"FAS":            {"colors": [Color8(193, 39, 45), Color8(0, 98, 51)],      "short": "MAR", "league": "NATIONAL", "type": "national"},
	"MISIR":          {"colors": [Color8(206, 17, 38), Color8(0, 0, 0)],        "short": "EGY", "league": "NATIONAL", "type": "national"},
	"SENEGAL":        {"colors": [Color8(0, 133, 63), Color8(253, 239, 66)],    "short": "SEN", "league": "NATIONAL", "type": "national"},
	"CEZAYİR":        {"colors": [Color8(0, 102, 51), Color8(255, 255, 255)],   "short": "ALG", "league": "NATIONAL", "type": "national"},
	"KAMERUN":        {"colors": [Color8(0, 122, 61), Color8(206, 17, 38)],     "short": "CMR", "league": "NATIONAL", "type": "national"},
	"GANA":           {"colors": [Color8(255, 255, 255), Color8(0, 0, 0)],      "short": "GHA", "league": "NATIONAL", "type": "national"},
	# Asya & Orta Doğu Devleri
	"JAPONYA":        {"colors": [Color8(0, 32, 96), Color8(255, 255, 255)],    "short": "JPN", "league": "NATIONAL", "type": "national"},
	"GÜNEY KORE":     {"colors": [Color8(235, 15, 41), Color8(10, 20, 110)],    "short": "KOR", "league": "NATIONAL", "type": "national"},
	"SUUDİ ARABİSTAN":{"colors": [Color8(0, 108, 53), Color8(255, 255, 255)],   "short": "KSA", "league": "NATIONAL", "type": "national"},
	"İRAN":           {"colors": [Color8(255, 255, 255), Color8(218, 0, 0)],    "short": "IRN", "league": "NATIONAL", "type": "national"},
	"AVUSTRALYA":     {"colors": [Color8(255, 205, 0), Color8(0, 132, 61)],     "short": "AUS", "league": "NATIONAL", "type": "national"},
	"KATAR":          {"colors": [Color8(141, 21, 58), Color8(255, 255, 255)],  "short": "QAT", "league": "NATIONAL", "type": "national"},
	# Kuzey/Orta Amerika & Avrupa Kült Ekipleri
	"MEKSİKA":        {"colors": [Color8(0, 104, 71), Color8(255, 255, 255)],   "short": "MEX", "league": "NATIONAL", "type": "national"},
	"KANADA":         {"colors": [Color8(255, 0, 0), Color8(255, 255, 255)],    "short": "CAN", "league": "NATIONAL", "type": "national"},
	"GÜRCİSTAN":      {"colors": [Color8(255, 255, 255), Color8(255, 0, 0)],    "short": "GEO", "league": "NATIONAL", "type": "national"},
	"İSVEÇ":          {"colors": [Color8(254, 204, 0), Color8(0, 106, 167)],    "short": "SWE", "league": "NATIONAL", "type": "national"},
	"YUNANİSTAN":     {"colors": [Color8(13, 94, 175), Color8(255, 255, 255)],  "short": "GRE", "league": "NATIONAL", "type": "national"},
	"ROMANYA":        {"colors": [Color8(252, 209, 22), Color8(0, 43, 127)],    "short": "ROU", "league": "NATIONAL", "type": "national"},
	"GALLER":         {"colors": [Color8(211, 17, 34), Color8(255, 255, 255)],  "short": "WAL", "league": "NATIONAL", "type": "national"},
	# --- TÜRKİYE LİGİ ---
