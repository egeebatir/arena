...
OVERLAY_BG = (20, 20, 20, 200) # Darker, more opaque for text bg
...
# FONTS
# UPDATED: Changed from Arial to 'impact' for chunkier look
font_score = pygame.font.SysFont("impact", 54) 
font_timer = pygame.font.SysFont("impact", 28)
font_event = pygame.font.SysFont("impact", 50)
font_team = pygame.font.SysFont("impact", 48) # UPDATED: Bigger size (was 26)
font_goal_list = pygame.font.SysFont("impact", 16)
...
while running:
    ...
    if state == "MENU":
        ...
        # Transparent White Background with Radius
        ...
        # Positioning Names (Adjusted for larger font)
        screen.blit(ts_surf, (panel_x + 30, 48)) 
        screen.blit(fb_surf, (panel_x + panel_w - fb_surf.get_width() - 30, 48))
        ...
        screen.blit(s1_surf, (center_score_x - 50, 35))
        screen.blit(dash_surf, (center_score_x - dash_surf.get_width()//2, 35))
        screen.blit(s2_surf, (center_score_x + 30, 35))
        ...
        def draw_big_notif(txt, col, y):
            ...
            text_rect = nsurf.get_rect(center=(WIDTH//2, y + nsurf.get_height()//2))
            
            # UPDATED: REMOVED BACKGROUND RECTANGLE DRAWING
            
            screen.blit(nsurf, text_rect)
            return y + text_rect.height + 10
